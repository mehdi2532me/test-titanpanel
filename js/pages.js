    ...
    view.innerHTML = `
      ...
      <div class="grid grid-2">
        ...
        <div class="panel"><div class="panel-head"><div class="panel-title" data-i18n="sec_security"></div></div>
          <div class="panel-body">
            <label class="field"><span class="field-label" data-i18n="set_old_password"></span><input class="input" type="password" id="oldPass" autocomplete="current-password"></label>
